  ...
  <div id="purpose-ministry" class="container">
    <div class="row top-buffer-20" style="padding-bottom: 0px">
      <div class="col-xs-12">
        <h2>Our <em><span class="bold">purpose </span></em><span style="font-size: 0.8em;">is to develop the next leaders with an unshakeable integrity and a humble character that love to serve.</span></h2>
      </div>
  ...
  <?php /*Section: Howard University - Mission*/ ?>
  <div id="mission" class="container-fluid">
    <div class="row" style="padding-bottom: 20px">
      <div class="col-xs-1"></div>
      <div class="col-xs-10">
        <h2 id="mission-headline">Our <em><span class="bold">mission </span></em><span style="font-size:0.8em;"> is to help students become leaders through a Gospel-based relationship at Howard University.</span></h2>
        <hr style="border-color: #c80000; height:10px"/>
        <h3>Our mission extends from our <a href="http://impactmovement.org/about-us/our-mission-vision-and-values/" target="_blank">national ministry’s mission</a>:<br/> - to take the truth of Jesus Christ to the campus, community and world by producing leaders of African descent who are spiritually focused, financially responsible and morally fit.</h3>
      </div>
      <div class="col-xs-1"></div>
    </div>
  </div>
  ...
  <div id="campus-relevance" class="container" align="center">
    <div class="row top-buffer-5" style="padding-bottom: 0px">
      <div class="col-xs-12">
        <h2 style="text-align: justify;">Our <em><span class="bold">relevance </span></em><span style="font-size: 0.5em;">to Howard University begins at the conception of this prestigious institution called the “Howard Normal and Theological School for the Education of Teachers and Preachers.” We, too, are a proactive organization within the university providing a platform for our next leaders to practice educating each other with solid demonstrations and examples that do the preaching and teaching. In other words, allowing students to practice what they “preach” and increase their teaching techniques.
        Considering respectfully that Howard University’s core mission was to aid <a href="https://en.wikipedia.org/wiki/Freedmen%27s_Bureau" target="_blank">“freed men”</a> (or freed slaves), we are also similarly missional. Our hope is to awaken our brothers and sisters to seeing the modern slavery mechanisms hiding in our broken systems while planting seeds to seek methods in breaking such chains among our communities.</span></h2>
      </div>
    </div>
    <div class="row top-buffer-20">
      <div class="col-md-4">
        <div class="panel panel-default">
          ...
          <div class="panel-footer">
            <h3 class="point-of-message">- We <a href="https://www.biblegateway.com/passage/?search=John+8%3A31-32&version=ESV" target="_blank" alt="The truth will set you free.">live free. </a>-</h3>
          </div>
        </div>
      </div>
      <div class="col-md-4">
      ...
      <div class="col-md-4">
          <div class="panel panel-default">
            ...
            <div class="panel-footer">
              <h3><div class="point-of-message">- We <a href="https://www.biblegateway.com/passage/?search=Mark+10%3A42-45&version=NIV" target="_blank" alt="Our greatest gift is to serve people.">serve humbly. </a>-</div></h3>
            </div>
          </div>
      </div>
    </div><!--row-->
...
*/ ?>
  <?php /*Section: Impact Howard - Purpose*/ ?>
  <!--p>
    We study the Bible with all intent to disect each message along with the 
    overall message in understanding the truth that it holds. There is no doubt or 
     that the Gospel itself reveals so much of the way to live a prosperous life, 
     from the cradle to the kingdom, by simply doing one thing - live like Jesus. 
     Yet in order to live like Jesus, we must first understand who this person is. 
     This is the core of our studies. We seek to understand who He is, how we can be 
     like Him, who we are in Him, and showing others who He is. There is no better 
     role model to model our role - in all that we do.
  </p-->
